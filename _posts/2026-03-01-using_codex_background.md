...
- manually alter the latex code <br>
- ask codex to change specific parts of the cv by providing section, subsection information. <br>
The only problem is that, I've to the prompting & validation in two interfaces in above setup. <br>

- manual alteration - entirely carried out in Streamlit app <br>
